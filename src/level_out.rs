...
const LEVELS:  &'static[u8] = &[
    ...
    // L_63
    0x50, 0x11, 0x0f, 0x26, 0xaf, 0x32, 0xd8, 0x62, 0xde, 0x10,
    0x08, 0xe4, 0x5a, 0x62, 0x6c, 0x4c, 0x86, 0x43, 0xad, 0x48,
    0x3a, 0xe2, 0x53, 0x42, 0x88, 0x64, 0x9c, 0x36, 0x08, 0xe4,
    0x4a, 0x62, 0x5c, 0x4d, 0x3a, 0xe2, 0x9c, 0x32, 0xfc, 0x41,
    0x3c, 0xb1, 0x83, 0x00, 0xac, 0x42, 0x2a, 0xe2, 0x3c, 0x46,
    0xaa, 0x62, 0xbc, 0x4e, 0xc6, 0x43, 0x46, 0xc3, 0xaa, 0x62,
    0xbd, 0x48, 0x0b, 0x96, 0x47, 0x07, 0xc7, 0x12, 0x3c, 0xc2,
    0x9c, 0x41, 0xcd, 0x48, 0xdc, 0x32, 0x4c, 0xc2, 0xbc, 0x32,
    0x1c, 0xb1, 0x5a, 0x62, 0x6c, 0x44, 0x76, 0x43, 0xba, 0x62,
    0xdc, 0x32, 0x5d, 0xca, 0x73, 0x12, 0xe3, 0x12, 0x8e, 0x91,
    0x9d, 0x41, 0xbe, 0x42, 0xef, 0x20, 0xcd, 0xc7, 0xfd,
...
const ENEMIES:  &'static[u8] = &[
    ...
    // E_63
    0x0f, 0x02, 0x28, 0x10, 0xe6, 0x03, 0xd8, 0x90, 0x0f, 0x05,
    0x85, 0x0f, 0x78, 0x83, 0xc8, 0x10, 0x18, 0x83, 0x58, 0x83,
    0xf7, 0x90, 0x0f, 0x0c, 0x43, 0x0f, 0x73, 0x8f, 0xff,
];
...
//    output_level(5, &mut out, false);
//    output_level(0, &mut out, false);
//    output_level(3, &mut out, false);
//    output_level(7, &mut out, false);
//    output_level(2, &mut out, false);
//    output_level(8, &mut out, false);
//    output_level(1, &mut out, false);
//    for i in (0...13).rev() {
//        output_level(i, &mut out, false);
//    }
